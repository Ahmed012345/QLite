...
public class LostRecordsActivity extends LocalizationActivity implements LostRecordsContract.View {
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		LightTextView btn_file_browser = findViewById(R.id.btn_file_browser);
		new ClickShrinkEffect(btn_file_browser);
		btn_file_browser.setOnClickListener(v -> startActivity(FileBrowserActivity.getStartIntent(getApplicationContext())));

		txtEmpty = findViewById(R.id.txtEmpty);
		new ClickShrinkEffect(txtEmpty);
		Button btnDeleteAll = findViewById(R.id.btn_delete_all);
		new ClickShrinkEffect(btnDeleteAll);
